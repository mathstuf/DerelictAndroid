...
// tts.h
static immutable string ANDROID_TTS_ENGINE_PROPERTY_CONFIG = "engineConfig";
static immutable string ANDROID_TTS_ENGINE_PROPERTY_PITCH  = "pitch";
static immutable string ANDROID_TTS_ENGINE_PROPERTY_RATE   = "rate";
static immutable string ANDROID_TTS_ENGINE_PROPERTY_VOLUME = "volume";
...
alias android_tts_result_t = int;
...
alias android_tts_support_result_t = int;

enum : int {
    ANDROID_TTS_SYNTH_DONE              = 0,
    ANDROID_TTS_SYNTH_PENDING           = 1
}
alias android_tts_synth_status_t = int;

enum : int {
    ANDROID_TTS_CALLBACK_HALT           = 0,
    ANDROID_TTS_CALLBACK_CONTINUE       = 1
}
alias android_tts_callback_status_t = int;
...
alias android_tts_audio_format_t = int;

struct android_tts_engine_t {
    android_tts_engine_funcs_t *funcs;
}

extern( C ) nothrow alias android_tts_synth_cb_t = android_tts_callback_status_t function
            (void **pUserData,
